    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM Piastra WHERE Piastra.N_Pastra = " + n_piastra + "Or Piastra.Tecnico = "+tecnico+"Or Piastra.Data = "+data+" Or Piastra.C_Vegetale = "+campione+" Or Piastra.Nome_Azienda = "+azienda+";";
                connessione.Open();
